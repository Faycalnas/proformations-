...
document.querySelector("#btnSupCompte").addEventListener("click", function(){
    console.log("test");
    document.querySelector("#suppressionCompte").classList.remove("p_invisible");
})
document.querySelector("#btnClodeAlert").addEventListener("click", function(){
    document.querySelector("#suppressionCompte").classList.add("p_invisible");
})
